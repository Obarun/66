...
man5='66-deeper 66-frontend 66-instantiated-service 66-module-creation 66-module-usage 66-service-configuration-file 66-standard-io-redirection 66-upgrade-process 66-identifier'
...
for i in ${man1}; do
    lowdown -s -Tman "${i}".md -o doc/man/man1/"${i}".1 || exit 1
...
for i in ${man5}; do
    lowdown -s -Tman "${i}".md -o doc/man/man5/"${i}".5 || exit 1
...
for i in ${man8}; do
    lowdown -s -Tman "${i}".md -o doc/man/man8/"${i}".8 || exit 1
