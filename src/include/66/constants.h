...
#define SS_ADDON_DEPENDENCIES_SUFFIX ".dependencies"
#define SS_ADDON_DEPENDENCIES_SUFFIX_LEN (sizeof SS_ADDON_DEPENDENCIES_SUFFIX - 1)
#define SS_ADDON_REGEX_SUFFIX ".regex"
#define SS_ADDON_REGEX_SUFFIX_LEN (sizeof SS_ADDON_REGEX_SUFFIX - 1)
