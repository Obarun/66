...
extern int parse_event_source(struct resolve_hash_s *c, parse_build_ctx_t *ctx) ;
...
extern int parse_dependencies(parse_store_t *st, resolve_service_addon_dependencies_t *dep, char const *service) ;
