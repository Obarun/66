...
int parse_contents(resolve_service_t *res, resolve_service_addon_execute_t *ex, resolve_service_addon_dependencies_t *dep, char const *str)
{
    log_flow() ;
