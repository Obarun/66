...
static opt_t const opts_tree_status[] = {
    { .id = OPT_ID_HELP, .shortname = 'h', .longname = "help",     .arg = OPT_NONE,                             .help = "print this help" },
    { .id = 'n',         .shortname = 'n', .longname = "no-field", .arg = OPT_NONE,                             .help = "do not display the names of fields" },
...
static opt_cmd_t const tree_sub[] = {
    { .name = "create",  .help = "create a tree", .operands = "tree",
      .opts = opts_tree_admin, .nopts = OPT_COUNT(opts_tree_admin), .on_option = &on_tree_admin, .fn = &ssexec_tree_admin },
    { .name = "admin",   .help = "administrate an existing tree", .operands = "tree",
      .opts = opts_tree_admin, .nopts = OPT_COUNT(opts_tree_admin), .on_option = &on_tree_admin, .fn = &ssexec_tree_admin },
    { .name = "remove",  .help = "remove an existing tree", .operands = "tree",
      .opts = opts_tree_admin, .nopts = OPT_COUNT(opts_tree_admin), .on_option = &on_tree_admin, .fn = &do_tree_remove },
    { .name = "enable",  .help = "enable a tree", .operands = "tree",
      .opts = opts_tree_admin, .nopts = OPT_COUNT(opts_tree_admin), .on_option = &on_tree_admin, .fn = &do_tree_enable },
    { .name = "disable", .help = "disable a tree", .operands = "tree",
      .opts = opts_tree_admin, .nopts = OPT_COUNT(opts_tree_admin), .on_option = &on_tree_admin, .fn = &do_tree_disable },
