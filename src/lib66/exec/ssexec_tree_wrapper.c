...
static opt_cmd_t const tree_sub[] = {
    { .name = "create",  .help = "create a tree", .operands = "tree",
      .opts = opts_tree_admin, .nopts = OPT_COUNT(opts_tree_admin), .on_option = &on_tree_admin, .fn = &ssexec_tree_admin, .epilog = tree_admin_epilog },
    { .name = "admin",   .help = "administrate an existing tree", .operands = "tree",
      .opts = opts_tree_admin, .nopts = OPT_COUNT(opts_tree_admin), .on_option = &on_tree_admin, .fn = &ssexec_tree_admin, .epilog = tree_admin_epilog },
    { .name = "remove",  .help = "remove an existing tree", .operands = "tree",
      .opts = opts_help, .nopts = OPT_COUNT(opts_help), .fn = &do_tree_remove },
    { .name = "enable",  .help = "enable a tree", .operands = "tree",
      .opts = opts_help, .nopts = OPT_COUNT(opts_help), .fn = &do_tree_enable },
    { .name = "disable", .help = "disable a tree", .operands = "tree",
      .opts = opts_help, .nopts = OPT_COUNT(opts_help), .fn = &do_tree_disable },
    { .name = "current", .help = "mark a tree as the current one", .operands = "tree",
      .opts = opts_help, .nopts = OPT_COUNT(opts_help), .fn = &do_tree_current },
    { .name = "resolve", .help = "display the resolve files contents of tree", .operands = "tree",
      .opts = opts_tree_resolve, .nopts = OPT_COUNT(opts_tree_resolve), .on_option = &on_tree_resolve, .fn = &ssexec_tree_resolve, .epilog = tree_resolve_epilog },
    { .name = "status",  .help = "display information about tree", .operands = "tree",
      .opts = opts_tree_status, .nopts = OPT_COUNT(opts_tree_status), .on_option = &on_tree_status, .fn = &ssexec_tree_status, .epilog = tree_status_epilog },
    { .name = "init",    .help = "initiate all enabled services of a tree to a scandir", .operands = "tree",
      .opts = opts_help, .nopts = OPT_COUNT(opts_help), .fn = &ssexec_tree_init },
    { .name = "start",   .help = "bring up all services of a tree", .operands = "tree",
      .opts = opts_tree_signal, .nopts = OPT_COUNT(opts_tree_signal), .on_option = &on_tree_signal, .fn = &do_tree_start },
    { .name = "stop",    .help = "bring down all services of a tree", .operands = "tree",
      .opts = opts_tree_signal, .nopts = OPT_COUNT(opts_tree_signal), .on_option = &on_tree_signal, .fn = &do_tree_stop },
    { .name = "free",    .help = "bring down all services of a tree and unsupervise them", .operands = "tree",
      .opts = opts_tree_signal, .nopts = OPT_COUNT(opts_tree_signal), .on_option = &on_tree_signal, .fn = &do_tree_free },
} ;
